...
Route::middleware('auth')->group(function () {
    Route::get('/demo/schedule', [DemoScheduleController::class, 'index'])->name('demo.schedule');
    Route::post('/demo/schedule', [DemoScheduleController::class, 'store'])->name('demo.schedule.store');
});
